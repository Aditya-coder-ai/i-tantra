...
import com.itantra.offlinevoice.security.SecurityState
...
fun SecurityDebugScreen(
    ...
    remember {
        if (!controller.keyManager.isDeviceTrusted(recipientId)) {
            val peerKeyPair = com.itantra.offlinevoice.security.CryptoManager.generateEcKeyPair()
            val pubKey = com.itantra.offlinevoice.security.CryptoManager.encodePublicKey(peerKeyPair.public)
