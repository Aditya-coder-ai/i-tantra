package com.talkmitra.offlinevoice.ui.mock
...
import com.talkmitra.offlinevoice.audio.AudioRecorder
import com.talkmitra.offlinevoice.audio.RecordingState
import com.talkmitra.offlinevoice.audio.debug.AudioDebugHelper
import com.talkmitra.offlinevoice.audio.debug.AudioDiagnostics
import com.talkmitra.offlinevoice.audio.stt.AndroidSpeechRecognizerEngine
import com.talkmitra.offlinevoice.audio.stt.STTLanguage
import com.talkmitra.offlinevoice.audio.stt.STTResult
import com.talkmitra.offlinevoice.audio.stt.VoskSttEngine
import com.talkmitra.offlinevoice.audio.tts.TtsEngine
import com.talkmitra.offlinevoice.audio.vad.SpeechSegment
import com.talkmitra.offlinevoice.audio.vad.VoiceActivityDetector
import com.talkmitra.offlinevoice.communication.manager.ITantraCommunicationManager
import com.talkmitra.offlinevoice.communication.manager.TantraCommunicationManagerImpl
import com.talkmitra.offlinevoice.communication.model.DeliveryState
import com.talkmitra.offlinevoice.communication.model.PeerIdentity
import com.talkmitra.offlinevoice.security.CryptoManager
import com.talkmitra.offlinevoice.security.SecurityController
import com.talkmitra.offlinevoice.text.MessageBuilder
import com.talkmitra.offlinevoice.text.MessageClassifier
import com.talkmitra.offlinevoice.text.MessagePriority
import com.talkmitra.offlinevoice.text.MessageType
import com.talkmitra.offlinevoice.text.TextProcessor
import com.talkmitra.offlinevoice.network.ConnectionState
import com.talkmitra.offlinevoice.network.DeliveryUpdate
import com.talkmitra.offlinevoice.network.MessageDeliveryStatus
import com.talkmitra.offlinevoice.network.NetworkMetrics
import com.talkmitra.offlinevoice.network.PermissionHelper
import com.talkmitra.offlinevoice.network.TransportManager
import com.talkmitra.offlinevoice.network.TransportType
import com.talkmitra.offlinevoice.network.VoiceLinkDevice
...
import com.talkmitra.offlinevoice.translation.TextLanguageDetector
import com.talkmitra.offlinevoice.translation.TranslationEngine
import com.talkmitra.offlinevoice.translation.TranslationPath
import com.talkmitra.offlinevoice.translation.TranslationQueue
